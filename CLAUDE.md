...
| Art authoring (any new texture/decal) | [`ASSETS/ART_SPECIFICATIONS.md`](ASSETS/ART_SPECIFICATIONS.md) | `TEX_AUTHORING_N = 16` texels/voxel is PINNED; never pre-stretch for projection — the compositor owns it. §7 = damage decals (square 256×256, alpha, 3 variants/family/material) |
