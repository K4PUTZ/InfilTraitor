...
**Status:** 🟡 **PERF-01 SHIPPED (commit `5c533d1`). PERF-02 planned, not yet
implemented — next session starts here.** Two further ideas (colored-flash
choreography, real-explosion video overlay) are captured in §6 as explicit
future work, deliberately deferred past PERF-02 by the Director.
...
## 7. Acceptance (PERF-02, when implemented)
