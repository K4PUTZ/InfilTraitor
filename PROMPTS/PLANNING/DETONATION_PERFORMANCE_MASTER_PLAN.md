...
> ⏭️ **2026-09-25 — the costs this plan closed no longer exist as such (R3D-END).** The composite pages, the TileSet rebuild and the alternative mint were deleted with the 2D board; what is left of a blast's cost is the light's, measured at END-8 (`DEVICE_DIAGNOSTICS_MASTER_PLAN`, `RENDER3D` R3D-LIGHT).
