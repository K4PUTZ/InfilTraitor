...
Wave 3.12, closed 2026-07-14). Part 3 (agent-on-top) closed; the silhouette-stroke half is
...
yet — `main` is ahead at VERSION 0.9.13+ with Waves 1 through 3.12. Director's
call on when to tag.
