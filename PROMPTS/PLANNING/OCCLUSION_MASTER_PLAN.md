...
occlusion, and a modular per-unit 3D-box wireframe (O3‴/O10/O11/O12/O13/O14/O15,
Wave 3.13, closed 2026-07-14). Part 3 (agent-on-top) closed; the silhouette-stroke half is
...
yet — `main` is ahead at VERSION 0.9.14+ with Waves 1 through 3.13. Director's
call on when to tag.
