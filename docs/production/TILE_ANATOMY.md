...
**Date:** 2026-07-07  
**Tool:** `godot/scripts/tools/tile_anatomy_audit.gd` (headless Godot audit script; retired 2026-09-26, last present in `f4ddd52c`)  
...
Loading: res://ASSETS/materials/concrete/voxel_concrete.png
  • Dimensions: 32×36
...
Loading: res://ASSETS/materials/metal/voxel_metal.png
  • Dimensions: 32×36
  ✓ Dimensions match expected (32×36)
  • Alpha histogram:
    Total pixels: 1152
