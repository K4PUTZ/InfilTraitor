...
|-----------|---------|--------|-----------|
| DOC-01 | None (orthogonal) | Clear | — |
| M2.13 | M2.08 complete | Clear | — |
| M3.0 | M2.14 complete | Clear | — |
| M4.0 | Campaign design finalized | Clear | Design doc ready |
| M5.0 | Procedural generation algorithm | At risk | Use templated generation initially |
| M6.0 | Audio engineering resources | At risk | Contract external audio if needed |
| M7.0 | Platform deployment keys | Clear | Ready to deploy |

---

## Next Steps

1. **Immediate (this sprint):** Complete DOC-01 (documentation refactoring)
2. **Next sprint:** Begin M2.13 (Suspicion Meter Integration)
3. **3 sprints:** Campaign narrative start (M4.0)
4. **6 sprints:** First full campaign playable

See: `docs/production/roadmap.md` for timeline
See: `docs/production/backlog.md` for low-priority features
