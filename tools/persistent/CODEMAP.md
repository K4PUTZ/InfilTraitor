...
**223 scripts · 71352 lines total** (under `godot/scripts/`)
...
`class_name BlastCalculator` · 1839 lines
...
`class_name DetonationChoreographer` · extends `RefCounted` · 933 lines
...
`class_name MaterialResistanceTable` · 214 lines
