...
**188 scripts · 46174 lines total** (under `godot/scripts/`)
...
`class_name DetonationChoreographer` · extends `RefCounted` · 130 lines
...
`class_name DetonationPlanBuilder` · 467 lines
