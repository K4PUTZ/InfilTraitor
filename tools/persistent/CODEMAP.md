...
**230 scripts · 77000 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 5217 lines
...
`class_name GlassCrackSprite` · extends `Sprite2D` · 78 lines
