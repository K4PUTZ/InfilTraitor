...
**219 scripts · 68748 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 4224 lines
...
`class_name DetonationChoreographer` · extends `RefCounted` · 805 lines
