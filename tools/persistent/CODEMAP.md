...
**211 scripts · 61891 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 3324 lines
...
`class_name AgentShotController` · 468 lines
