...
**240 scripts · 87753 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 6852 lines
...
`class_name DetonationPlanBuilder` · 2478 lines
...
`class_name GlassShatter` · 762 lines
