...
**259 scripts · 97027 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 7871 lines
...
**Constants / tuning**
- `ARITY` = `{ "framing": 1, "zoom": 1, "centre": 1, "wait": 1, "frames": 1, "mark": -1, "window": 1, "capture": 1, "detonate": 1, "drop2d": 0, "quit": 0, "probe": 1, "alloc": 2, "capture_at": 3, "store_spike": 1, "probe_store": 1, "shoot": 1, "reload": 0, "save_restore": 0, "perspective": 1, "occupancy_compare": 1, "passages": 1, }`
