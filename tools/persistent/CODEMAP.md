...
**230 scripts · 77631 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 5375 lines
...
`class_name GlassCrackSprite` · extends `Sprite2D` · 100 lines
...
`class_name DetonationEntryWriter` · extends `RefCounted` · 256 lines
...
`class_name GlassCrack` · 189 lines
