...
**211 scripts · 62555 lines total** (under `godot/scripts/`)
...
`class_name BlastCalculator` · 1605 lines
...
`class_name AgentShotController` · 622 lines
