...
**245 scripts · 90525 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 7709 lines
...
`class_name MemStage` · extends `RefCounted` · 94 lines
...
`class_name RoomBuilder` · 1271 lines
