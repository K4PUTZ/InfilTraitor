...
**217 scripts · 66707 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 3770 lines
...
`class_name DetonationChoreographer` · extends `RefCounted` · 760 lines
