...
**223 scripts · 70528 lines total** (under `godot/scripts/`)
...
`class_name DetonationChoreographer` · extends `RefCounted` · 834 lines
...
`class_name SaveState` · extends `RefCounted` · 152 lines
