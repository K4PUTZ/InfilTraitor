...
**219 scripts · 68367 lines total** (under `godot/scripts/`)
...
`class_name VoxelRenderer` · extends `Node2D` · 4101 lines
...
`class_name DetonationChoreographer` · extends `RefCounted` · 797 lines
